...
import { createCompletionTracker, COMPLETION_FLOOR_PCT, COMPLETION_BAND_PCT } from './benchmark/completion.ts';
...
if (completionPass && completion < COMPLETION_BAND_PCT[0]) {
  console.log(`WARN: completion below the believable band [${COMPLETION_BAND_PCT[0]}, ${COMPLETION_BAND_PCT[1]}] — drifting toward the floor`);
}
