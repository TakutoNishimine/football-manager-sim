...
app.innerHTML = `
  ...
  <div class="tactics team0">
    <span class="teamLabel">青</span>
    <label>フォーメーション <select id="form0"></select></label>
    <label>マンマーク <input type="range" id="manMark0" min="0" max="1" step="0.05" value="0" /></label>
    <label>プレス <input type="range" id="press0" min="0" max="1" step="0.05" value="0.5" /></label>
    <label>ライン <input type="range" id="line0" min="-1" max="1" step="0.05" value="0" /></label>
    <label>ワイドのラン <input type="range" id="wideRuns0" min="0" max="1" step="0.05" value="0.5" /></label>
  </div>
  <div class="tactics team1">
    <span class="teamLabel">赤</span>
    <label>フォーメーション <select id="form1"></select></label>
    <label>マンマーク <input type="range" id="manMark1" min="0" max="1" step="0.05" value="0" /></label>
    <label>プレス <input type="range" id="press1" min="0" max="1" step="0.05" value="0.5" /></label>
    <label>ライン <input type="range" id="line1" min="-1" max="1" step="0.05" value="0" /></label>
    <label>ワイドのラン <input type="range" id="wideRuns1" min="0" max="1" step="0.05" value="0.5" /></label>
  </div>
...
let playing = true;
let speed = 0.25;
const overlays: Overlays = { passLanes: true, spaceControl: true, anchors: false, intents: true, futureSpace: false };
