...
const LEVER_BADGE = {
  ...
  // PPDA 0→5.44 / 1→3.52: 効果2.24σ・有意差7.09σ (task-af, run 29105999886)。プレス幾何
  // (2人組トラップ)の連続パラメータ化で復活。0.3→4.62 / 0.6→3.97 と中間域も単調に動く。
  pressIntensity:
    '<span class="lever-badge lever-badge--live" title="PPDA 0→5.44 / 1→3.52 (効果2.24σ・有意差7.09σ, task-af, N=20×10分)。プレス幾何(2人組トラップ)の連続パラメータ化で復活。0.3→4.62 / 0.6→3.97 と中間域も単調(有意差2.16σ)。強めるほど即時奪回=PPDAが下がる。">効果あり</span>',
